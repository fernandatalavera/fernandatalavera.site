    ...
    <section id="flavours" className="relative py-16 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-[#121212] tracking-tighter mt-2 overflow-hidden">
            <motion.span
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <motion.h3
                          className="text-4xl md:text-5xl font-black text-[#121212] tracking-tighter mt-1"
          ...
          <div className="flex justify-center gap-2 mt-6">
            {flavors.map((flavor, index) => (
              <motion.button
                ...
                style={{
                  backgroundColor:
                    index === currentIndex ? flavor.accentColor : "#12121220",
                }}
                animate={{
